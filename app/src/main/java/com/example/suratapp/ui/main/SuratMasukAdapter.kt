// SuratMasukAdapter.kt - Update filterByDate untuk maintain descending order
...
class SuratMasukAdapter(
    ...
    // SuratMasukAdapter.kt - Update bind()
    // SuratMasukAdapter.kt - ViewHolder bind()
